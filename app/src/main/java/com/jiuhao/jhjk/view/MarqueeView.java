...
import com.jiuhao.jhjk.utils.DisplayUtilone;
import com.jiuhao.jhjk.utils.ListUtil;
...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(R.styleable.MarqueeViewStyle_mvTextSize)) {
            ...
            textSize = DisplayUtilone.px2sp(context, textSize);
        }
    ...
    private void startWithFixedWidth(String notice, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        ...
        int width = DisplayUtilone.px2dip(getContext(), getWidth());
        if (width == 0) {
    ...
    public void startWithList(List<? extends CharSequence> notices, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        if (ListUtil.isEmpty(notices)) return;
        setNotices(notices);
        postStart(inAnimResId, outAnimResID);
    }
